...
<body>
    <div class="container">
        ...
        <form id="ticketForm">
            ...
            <a href="TicketCancel.php"><button type="submit" id="cancelTicketBtn">Cancel Ticket</button></a>
            <h5>*only registered users can get refund after ticket cancelation.</h5>
        </form>
    </div>
